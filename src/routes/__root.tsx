...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ultra-premium web design, modern full-stack development, and SEO that delivers measurable growth. Built for startups, founders, and global brands." },
      { name: "author", content: "WebWeave Studio" },
      { property: "og:title", content: "WebWeave Studio — Premium Web Design" },
      { property: "og:site_name", content: "WebWeave Studio" },
